...
public class PracticaObligatoriaTema2 {
    static void main() {
        ...
        String user, password, selecMenu , selecMenu2 = " ",selecHabitacion,numeroSinValidar ;
        ...
        boolean habitacion1Ind = false,habitacion2Ind = false,diaValido,punto;
                    ...
                    do {
                        do {
                            ...
                            do {
                                ...
                                numeroSinValidar = s.nextLine();
                                caracterValido = 0;
                                anioSalida = 0;
                                for (int i = 2; i < numeroSinValidar.length() ; i++) {
                                    if (Character.isDigit(numeroSinValidar.charAt(i))) caracterValido++;
                                }
                                if (numeroSinValidar.charAt(0) == '2' && numeroSinValidar.charAt(1) == '0' && caracterValido == 2 && numeroSinValidar.length() == 4)
                                    anioSalida = Integer.parseInt(numeroSinValidar);
                            ...
                            do {
                                ...
                                mesSalida = 0;
                                caracterValido = 0;
                                for (int i = 0; i < numeroSinValidar.length(); i++) {
                                    if (Character.isDigit(numeroSinValidar.charAt(i))) caracterValido++;
                                }
                                if (caracterValido == numeroSinValidar.length()) mesSalida = Integer.parseInt(numeroSinValidar);
                                if (mesSalida > MES_MAX || mesSalida == 0) System.out.println("Mes no existente");
                            ...
                            do {
                                ...
                                if (caracterValido == numeroSinValidar.length()) diaSalida = Integer.parseInt(numeroSinValidar);
                                diaValido = false;
                                switch (mesSalida) {
                                ...
                                if (!diaValido || diaSalida == 0) System.out.println("Dia no válido");
                        ...
                        if (selecValida && !selecHabitacion.equals("salir") && noches > 0) {
                            ...
                            do {
                                ...
                                for (int i = 0; i < numeroSinValidar.length(); i++) {
                                    if (Character.isDigit(numeroSinValidar.charAt(i))) caracterValido++;
                                    else if (numeroSinValidar.charAt(i) == '.' && !punto) {
                                        caracterValido++;
                                        punto = true;
                                    }
                                }
                                if (caracterValido == numeroSinValidar.length())dineroIntroducido = Double.parseDouble(numeroSinValidar);
                                ...
                                if (dineroIntroducido < precioFinal) {
                                    ...
                                    System.out.print(cambio > 0 ?"El cambio es: ":"Pago completado sin cambio");
                                ...
                                do {
                                    ...
                                    switch (selecMenu2) {
                                        case "i"://Opción ver ingresos y reservas hechas en total
                                            ...
                                            System.out.printf("Los ingresos totales son: %.2f €",ingresos);
